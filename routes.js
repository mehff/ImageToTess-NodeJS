...
//     middlewares.setHomePage(req, res);
//     homeController.mainPage(req, res);
// }
...
// router.post("/upload-multiple", arrayUpload, fileHandling.fileUploading, fileHandling.sendToOCR , fileHandling.baribers, middlewares.setSuccessPage, homeController.mainPage);
